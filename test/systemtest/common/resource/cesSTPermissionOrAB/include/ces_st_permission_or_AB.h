...
#ifndef _ces_st_permission_or_AB_
#define _ces_st_permission_or_AB_
...
{
    APP_LOGI(
        "CesSTPermissionOrAB::OnReceiveEvent --------------------------------------------------------------------");
}

class CesSTPermissionOrAB : public Ability {
protected:
...
#endif  // _ces_st_permission_or_AB_