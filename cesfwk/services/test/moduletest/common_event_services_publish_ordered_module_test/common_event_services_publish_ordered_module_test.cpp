 ...
 * @tc.name: CommonEventControlManager FinishReceiverLocked
 * @tc.desc: test FinishReceiverLocked recordPtr is null, verify FinishReceiverLocked recordPtr is return false
 */
