...
#ifndef _ces_st_permission_default_A_
#define _ces_st_permission_default_A_
...
{
    APP_LOGI(
        "CesSTPermissionDefaultA::OnReceiveEvent --------------------------------------------------------------------");
}

class CesSTPermissionDefaultA : public Ability {
protected:
...
#endif  // _ces_st_permission_default_A_